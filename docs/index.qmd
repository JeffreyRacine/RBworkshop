...
- **Zoom** by holding down the Alt key in MS Windows, Opt key in macOS or Ctrl key in Linux, and clicking on any element (e.g., a small figure - Alt/Opt/Ctrl click again to zoom out)
