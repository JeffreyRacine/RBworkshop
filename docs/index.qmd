...
- `lwage` is the logarithm of an individual's average hourly earnings, and `numdep` is their number of dependants $\{0,1,\dots,6\}$
...
- We estimate the joint density $\hat f(lwage,numdep)$ and plot it in @fig-wage1mixeddensity
