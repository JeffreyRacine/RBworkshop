...
format:
  revealjs:
    ...
    theme: simple
    touch: true
    ## multiplex: presentation.html	This is the file you should publish online and that your audience should view.
...
- Link to slides - <a href="https://jeffreyracine.github.io/RBworkshop">jeffreyracine.github.io/RBworkshop</a>

- View **full screen** by pressing the F key (Esc to revert)

- Access **navigation menu** by pressing the M key (X in navigation menu to close)

- **Advance** using arrow keys

- **Zoom** in by holding down the Alt key in MS Windows, Opt key in macOS or Ctrl key in Linux, and clicking on any element (e.g., a small figure - Alt/Opt/Ctrl click again to zoom out)

- Use **copy to clipboard** button for R code blocks (upper right in block) to copy and paste into R/RStudio 

- **Export to a PDF** by pressing the E key (wait a few seconds, then from the print menu enable landscape layout then save as PDF - press E to revert)
...
- The website with install info for R, RStudio, and TeX is

  <https://jeffreyracine.github.io/RBworkshop>

- The GitHub repository with example code is

  <https://github.com/JeffreyRacine/RBworkshop>
...
- Below is a nonparametric density estimate and data *rug* for the `eruptions` data (it is bi-modal *and* asymmetric)
...
## Nonparametric Essentials - Numeric Data
...
- Below are non-smooth and smooth nonparametric density estimates for the *numeric* variable `eruptions`
...
- The old way of doing research is to run your analyses using R, then to manually copy figures and tables into a word processor (e.g., MS Word) or typesetter (e.g., TeX) 
...
- Perhaps best of all, your Quarto file can be *rendered* into any imaginable output format

- <a href="https://quarto.org">Quarto</a>, <a href="https://github.com">GitHub</a> and <a href=https://rstudio.github.io/renv>renv</a> are supported in <a href="https://posit.co/products/open-source/rstudio/">RStudio</a>
