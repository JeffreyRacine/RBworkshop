...
- Link to slides - <a href="https://jeffreyracine.github.io/RBworkshop">jeffreyracine.github.io/RBworkshop</a> (case sensitive)
...
- **Export to a PDF** by pressing the E key (wait a few seconds, then from the print menu enable landscape layout then save as PDF - press the E key to revert)

- Enable drawing tools - **blackboard** by pressing the B key (B to revert), **crayon** by pressing the C key (C to revert), press the Del key to erase, press the D key to **download drawings**
