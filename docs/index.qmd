...
- Access **navigation menu** by pressing the M key (X to close)

- **Advance** using arrow keys

- **Zoom** by holding down the Alt key in MS Windows, Option key in macOS or Ctrl key in Linux, and clicking on any element (e.g., a small figure)
